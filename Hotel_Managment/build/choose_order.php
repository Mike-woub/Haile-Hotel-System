...
<body class="dark:text-white dark:bg-slate-600">
    ...
    <Header class="w-full sticky  bg-slate-50 dark:bg-slate-700 top-0 z-10">
      ...
      <div class="content-wrapper-rooms">
        ...
        <h1 class="text-4xl text-center mb-5">Choose Orders</h1>
        
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:pb-10">
            <a href="#" onclick="forward('pending');"  class="card cursor-pointer hover:bg-cyan-50 flex flex-col sm:max-h-96 items-center border border-slate-100 rounded-xl drop-shadow-2xl bg-lime-100 dark:text-black">
                <img src="img/bell.jpg" alt="" class="w-full overflow-hidden rounded-xl">
                <p class="sm:mt-4">Pending Orders</p>
            </a>
            <a href="#" onclick="forward('completed');"  class="card cursor-pointer hover:bg-cyan-50 flex flex-col sm:max-h-96 items-center border border-slate-100 rounded-xl drop-shadow-2xl bg-lime-100 dark:text-black">
                <img src="img/f3.jpg" alt="" class="w-full overflow-hidden rounded-xl">
                <p class="sm:mt-4">Completed Orders History</p>
            </a>
            <a href="#" onclick="forward('all');"  class="card cursor-pointer hover:bg-cyan-50 flex flex-col sm:max-h-96 items-center border border-slate-100 rounded-xl drop-shadow-2xl bg-lime-100 dark:text-black col-span-1 sm:col-span-2 lg:col-span-1">
                <img src="img/de1.jpg" alt="" class="w-full overflow-hidden rounded-xl">
                <p class="sm:mt-4">All Orders History</p>
            </a>
        </div>
